...
def handler(event, context):
    print(f"Executing handler in: blackbox_extract_text_from_file.py")
    
    # Use the models module
    model = models.ServiceModel(name="blackbox_extract_text_from_file.py")
    ...
    response_body = {
        ...
        "handler_file": "blackbox_extract_text_from_file.py",
