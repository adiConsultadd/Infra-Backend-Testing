...
def handler(event, context):
    print(f"Executing handler in: blackbox_table_of_content_lambda.py")
    
    # Use the models module
    model = models.ServiceModel(name="blackbox_table_of_content_lambda.py")
    ...
    response_body = {
        ...
        "handler_file": "blackbox_table_of_content_lambda.py",
