...
def handler(event, context):
    print(f"Executing handler in: blackbox_toc_enrichment_lambda.py")
    
    # Use the models module
    model = models.ServiceModel(name="blackbox_toc_enrichment_lambda.py")
    ...
    response_body = {
        ...
        "handler_file": "blackbox_toc_enrichment_lambda.py",
