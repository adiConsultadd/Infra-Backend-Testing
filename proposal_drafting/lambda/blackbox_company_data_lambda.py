...
def handler(event, context):
    print(f"Executing handler in: blackbox_company_data_lambda.py")
    
    # Use the models module
    model = models.ServiceModel(name="blackbox_company_data_lambda.py")
    ...
    response_body = {
        ...
        "handler_file": "blackbox_company_data_lambda.py",
