...
def handler(event, context):
    print(f"Executing handler in: blackbox_content_regeneration_lambda.py")
    
    # Use the models module
    model = models.ServiceModel(name="blackbox_content_regeneration_lambda.py")
    ...
    response_body = {
        ...
        "handler_file": "blackbox_content_regeneration_lambda.py",
