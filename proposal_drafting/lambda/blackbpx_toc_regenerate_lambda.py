...
def handler(event, context):
    print(f"Executing handler in: blackbpx_toc_regenerate_lambda.py")
    
    # Use the models module
    model = models.ServiceModel(name="blackbpx_toc_regenerate_lambda.py")
    ...
    response_body = {
        ...
        "handler_file": "blackbpx_toc_regenerate_lambda.py",
