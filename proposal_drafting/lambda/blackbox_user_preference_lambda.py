...
def handler(event, context):
    print(f"Executing handler in: blackbox_user_preference_lambda.py")
    
    # Use the models module
    model = models.ServiceModel(name="blackbox_user_preference_lambda.py")
    ...
    response_body = {
        ...
        "handler_file": "blackbox_user_preference_lambda.py",
