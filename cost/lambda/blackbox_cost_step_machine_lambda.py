...
def handler(event, context):
    print(f"Executing handler in: blackbox_cost_step_machine_lambda.py")
    
    # Use the models module
    model = models.ServiceModel(name="blackbox_cost_step_machine_lambda.py")
    ...
    response_body = {
        ...
        "handler_file": "blackbox_cost_step_machine_lambda.py",
