...
def handler(event, context):
    print(f"Executing handler in: blackbox_rfp_cost_image_extractor_lambda.py")
    
    # Use the models module
    model = models.ServiceModel(name="blackbox_rfp_cost_image_extractor_lambda.py")
    ...
    response_body = {
        ...
        "handler_file": "blackbox_rfp_cost_image_extractor_lambda.py",
