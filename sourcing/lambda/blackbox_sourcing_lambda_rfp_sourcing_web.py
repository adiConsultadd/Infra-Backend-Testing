...
def handler(event, context):
    print(f"Executing handler in: blackbox_sourcing_lambda_rfp_sourcing_web.py")
    
    # Use the models module
    model = models.ServiceModel(name="blackbox_sourcing_lambda_rfp_sourcing_web.py")
    ...
    response_body = {
        ...
        "handler_file": "blackbox_sourcing_lambda_rfp_sourcing_web.py",
